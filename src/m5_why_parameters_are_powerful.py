...
def main():
   ...
   # better_draw_circles(rg.Point(100, 50), 15)
    ...
    even_better_draw_circles(rg.Point(-400, 0), 3, 15, 'blue', 1)
    even_better_draw_circles(rg.Point(80, 10), 20, 1, 'magenta', 10)
    even_better_draw_circles(rg.Point(20, 80), 70, 5, 'green', 20)
    even_better_draw_circles(rg.Point(-400, 20), 25, 20, 'pink', 1)
    even_better_draw_circles(rg.Point(-300, -400), 30, 5, 'midnight blue', 10)
    window.update()
...
def better_draw_circles(point, v):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(v * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, v, s, color, t):
    ...
    turtle.pen.thickness = t
    turtle.pen_up()
    turtle.go_to(point)
    turtle.set_heading(0)  # Point "east" (towards the right)

    for k in range(0, s):  # k becomes 1, 2, 3, ... 10
